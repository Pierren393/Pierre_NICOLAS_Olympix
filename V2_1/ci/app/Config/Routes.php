...
$routes->get('concours/inscription', [Candidature::class, 'inscription']);
...
$routes->get('concours/afficher_galerie_candidature/candidature/(:segment)', [Candidature::class, 'afficher_concours_candidature']);
...
$routes->get('compte/afficher_concours/afficher_galerie_candidature/(:segment)', [Compte::class, 'afficher_galerie_candidature']);
$routes->get('compte/afficher_concours/afficher_galerie_candidature/candidature/(:segment)', [Compte::class, 'afficher_concours_candidature']);
$routes->get('compte/afficher_concours/(:segment)', [Compte::class, 'afficher_concours_concours']);
$routes->match(["get","post"],'compte/afficher_concours/ajouter_concours', [Compte::class, 'ajouter_concours']);
