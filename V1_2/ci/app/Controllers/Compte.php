...
class Compte extends BaseController
{
    ...
    public function creer()
    {
        ...
        if ($this->request->getMethod() == "post") {
            if (! $this->validate([
                'pseudo' => 'required|max_length[300]|min_length[2]',
    ...
    public function changer_mdp()
    {
        ...
        if ($this->request->getMethod() == "post" && $data['compte']->adm_id != null) {
            ...
            if (!$this->validate([
                ...
                'url' => 'max_length[300]|min_length[1]',
                'mdp' => 'required|max_length[300]|min_length[8]',
                'mdp2' => 'required|max_length[300]|min_length[8]|matches[mdp]'
            ], [
                // Configuration des messages d’erreurs
                ...
                'email' => [
                    ...
                    'max_length' => 'L’adresse e-mail doit contenir au maximum 300 caractères.'
                ],
                'discipline' => [
                    'required' => 'Champs de saisie vides !',
        ...
        if ($this->request->getMethod() == "post" && $data['compte']->adm_id != null) {
            if (!$this->validate([
                ...
                'login' => [
                    ...
                    'max_length' => 'Le login doit contenir au maximum 300 caractères.',
                ...
                'nom' => [
                    'required' => 'Champs de saisie vides !.',
                    'min_length' => 'Le nom doit contenir au moins 2 caractères.',
                    'max_length' => 'Le nom doit contenir au maximum 300 caractères.'
                ],
                'mdp' => [
                    'required' => 'Champs de saisie vides !',
                    'min_length' => 'Le mot de passe doit contenir au moins 8 caractères.',
